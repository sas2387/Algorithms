/**
 * Given (x,y) co-ordinates as the starting point of the spiral
 * and number of segments in a spiral,
 * print the co-ordinates of the spiral endpoints.
 * Eg: Spiral starting with (0,0) and 5 segments
 * (1,0)
 * (1,1)
 * (-1,1)
 * (-1,-1)
...
public class SpiralEndpoints {
	...
	private void printEndPointsOfSpiral(Point p, int totalSegments, int length, int segmentsSeen) {
